...
{
class SubRobotStatusAction : public BT::RosTopicSubNode<rm_interfaces::msg::RobotStatus>
{
public:
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<rm_interfaces::msg::RobotStatus>("robot_status")};
  }

  BT::NodeStatus onTick(
    const std::shared_ptr<rm_interfaces::msg::RobotStatus> & last_msg) override;
};
}  // namespace rm_behavior_tree
