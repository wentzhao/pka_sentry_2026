#ifndef RM_BEHAVIOR_TREE__PLUGINS__ACTION__IS_STATUS_BAD_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__ACTION__IS_STATUS_BAD_HPP_
 ...
 */
class IsStatusBadAction : public BT::SimpleConditionNode
{
public:
  IsStatusBadAction(const std::string & name, const BT::NodeConfig & config);
