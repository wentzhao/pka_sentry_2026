#ifndef RM_BEHAVIOR_TREE__PLUGINS__ACTION__CALCULATE_GAME_TIME_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__ACTION__CALCULATE_GAME_TIME_HPP_
 ...
 */
class CalculateGameTimeCondition : public BT::SimpleConditionNode
{
public:
  CalculateGameTimeCondition(const std::string & name, const BT::NodeConfig & config);
  ...
  {
    return {
      BT::InputPort<rm_interfaces::msg::GameStatus>("message"),
