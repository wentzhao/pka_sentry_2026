#ifndef RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_RFID_NOT_DETECTED_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_RFID_NOT_DETECTED_HPP_
 ...
 */
class IsRfidNotDetectedCondition : public BT::SimpleConditionNode
{
public:
  IsRfidNotDetectedCondition(const std::string & name, const BT::NodeConfig & config);
