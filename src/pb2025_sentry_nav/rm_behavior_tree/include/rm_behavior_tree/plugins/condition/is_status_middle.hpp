#ifndef RM_BEHAVIOR_TREE__PLUGINS__ACTION__IS_STATUS_MIDDLE_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__ACTION__IS_STATUS_MIDDLE_HPP_
 ...
 * @param[in] hp_threshold 最低血量阈值（哨兵最大血量400）
 */
class IsStatusMiddleAction : public BT::SimpleConditionNode
{
public:
  IsStatusMiddleAction(const std::string & name, const BT::NodeConfig & config);
  ...
  {
    return {
      BT::InputPort<rm_interfaces::msg::RobotStatus>("message")};
  }
};
}  // namespace rm_behavior_tree
...
//   {
//     return {
//       BT::InputPort<rm_interfaces::msg::NavigationReceive>("message"),
