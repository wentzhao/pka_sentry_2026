...
//   // if(i<=1000*3.14)
//   // {
//   //   yaw_text = 30.0*sin(8*i)+(rand()%800)*0.01;
//   //   picth_text = 10*sin(8*i)+(rand()%500)*0.01;
//   // } 
//   // i+=0.001;
//   // std::cout<<"yaw_text:"<<yaw_text<<std::endl;

//   packet.loadData<float>(static_cast<float>(data.pitch), 2);
//   packet.loadData<float>(static_cast<float>(data.yaw), 6);
//   // packet.loadData<float>(static_cast<float>(picth_text),2);
//   // packet.loadData<float>(static_cast<float>(yaw_text), 6);
