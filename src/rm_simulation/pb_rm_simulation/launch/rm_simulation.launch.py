...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=WorldType.SHENGSAI2025,
    ...
    bringup_SHENGSAI_cmd_group = create_gazebo_launch_group(WorldType.SHENGSAI2025)
    ...
    ld.add_action(bringup_SHENGSAI_cmd_group)
