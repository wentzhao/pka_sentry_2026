...
: Node("small_gicp_relocalization", options)
{
  ...
  // Estimate covariances of points协方差
...
void SmallGicpRelocalizationNode::performRegistration()//gicp
{
...
void SmallGicpRelocalizationNode::publishTransform()//map到odom重定位发布
{
  if (result_T_.isZero()) {
    return;
  }
